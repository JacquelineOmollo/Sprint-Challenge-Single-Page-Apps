...
- [ ] Explain benefit(s) using `client-side routing`?
  > Answer:less data is processed, routing between views is generally faster and smooth transitions between components.
- [ ] What does AJAX stand for?
  > Answer: AJAX stands for Asynchronous JavaScript and XML.
- [ ] What are `controlled components` in React?
  > Answer:A Controlled Component takes its current value through props and notifies changes through callbacks. A parent component “controls” it by handling the callback and managing its own state and passing the new values as props to the controlled component.
- [ ] Name three tools/libraries for making AJAX requests.
  > Answer: axios, Request and Fetch Api
